...
import com.repair.apps.adapter.DeleteListener
import com.repair.apps.adapter.ItemAlbumAdapter
import com.repair.apps.adapter.ItemAlbumAdapter2
import com.repair.apps.adapter.ItemClickListener
...
import com.repair.apps.uitl.ConstantUtil.ALBUM_REQUEST_CODE
...
class RequestDialogFragment : BaseBindDialogFragment<FragmentRequestBinding>() {
    ...
    private val itemAlbumAdapter by lazy { ItemAlbumAdapter2(requireActivity(), list, mMaxNumber) }
...
//        binding.addressText
        ...
        itemAlbumAdapter.setOnItemClickListener(object : ItemClickListener {
        ...
        itemAlbumAdapter.setOnDeleteClickListener(object : DeleteListener {
