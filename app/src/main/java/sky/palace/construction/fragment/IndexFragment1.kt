...
import sky.palace.construction.databinding.FragmentIndex1Binding
import sky.palace.construction.http.IndexViewModel
import sky.palace.construction.model.AdBannerDto
...
class IndexFragment1 : BaseAppBVMFragment<FragmentIndex1Binding, IndexViewModel>() {
    ...
    private val indexTagAdapter by lazy { sky.palace.construction.adapter.ItemIndexContentTagAdapter() }
    override fun initialize(savedInstanceState: Bundle?) {
        ...
        indexTagAdapter.setOnItemClickListener(listener = object :
            ...
            override fun onItemClick(holder: Any, item: IndexItemTagDto, position: Int) {
                val request = sky.palace.construction.dialog.RequestDialogFragment()
